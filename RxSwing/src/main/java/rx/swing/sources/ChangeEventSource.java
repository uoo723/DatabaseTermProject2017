...
public enum ChangeEventSource {
    ...
    public static Observable<ChangeEvent> fromChangeEventsOf(final Object changeEventSource) {
        ...
        return Observable.<ChangeEvent>create(e -> {
            final ChangeListener listener = e::onNext;
            addChangeListener(changeEventSource, listener);
            e.setDisposable(Disposables.fromAction(() -> removeChangeListener(changeEventSource, listener)));
        })
