...
public class InquiryEmployee extends UseCase<String, Employee> {
    private final DataSource dataSource;

    @Inject
    InquiryEmployee(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread,
    ...
    @Override
    Observable<Employee> buildUseCaseObservable(String employeeName) {
        return dataSource.getEmployee(employeeName).toObservable();
    }
}
